...
-(void)setItems:(PgItems *)items
{
    ...
    _titleLabel.text = items.component.title;
    _titleLabel.frame = CGRectMake(86, 14, 361, 25);
    
    
    for (NSString * array in items.component.pics)
    {
        if (items.component.pics.count==1)
        {
        ...
        {
            [_leftImage sd_setImageWithURL:items.component.pics[0]];
            [_centreImage sd_setImageWithURL:items.component.pics[1]];
            _leftImage.hidden = NO;
            _centreImage.hidden = NO;
            
        }else
        {
            [_leftImage sd_setImageWithURL:items.component.pics[0]];
            [_centreImage sd_setImageWithURL:items.component.pics[1]];
            [_rightImage sd_setImageWithURL:items.component.pics[2]];
            _leftImage.hidden = NO;
            _centreImage.hidden = NO;
    ...
    if (items.component.pics==nil) {
        _leftImage.hidden = YES;
        _centreImage.hidden = YES;
        _rightImage.hidden = YES;
        
        [_userImage sd_setImageWithURL:[NSURL URLWithString:items.component.userAvatar]];
        _userImage.frame = CGRectMake(30, 192-125, 40, 40);
        [_userBut setTitle:items.component.userName forState:UIControlStateNormal];
        ...
        _dateLable.text = items.component.publishDate;
        NSLog(@"------------%@",items.component.publishDate);
        ...
        _vLabel.text = items.component.v;
        ...
        _CommentCountLabel.text = items.component.commentCount;
