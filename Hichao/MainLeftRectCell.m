...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _textLabel.frame = CGRectMake(self.frame.size.height*1.2, 0, self.frame.size.width - self.frame.size.height*1.8, self.frame.size.height);
        ...
        _accessoryView = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width-self.frame.size.height*0.6, self.frame.size.height*0.35, self.frame.size.height*0.3, self.frame.size.height*0.3)];
